...
<body>
                ...
                <div class="topbar">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-1">
                                <picture class="logo">
                                    <img class="searchbarimage" src="{{ asset('images/layout/googlelogo.png') }}" />
                                </picture>
                            </div>
                            <div class="col-lg-9">
                                <div class="searchbar" type="text">
                                    <input class="searchbartext" type="text" id="filter" name="filter" value="" />
                            ...
                            <div class="col-lg-2 ">
                                <div class="content-options">
                                    ...
                                    <a class="custom-btn custom-btn-primary" href="{{ route('logout') }}"
                ...
                <div class="optionsbar">
                    <ul class="optionsmenu1">
                        <li class="optionsmenuactive tab-item">
                            <span class="icon"><svg focusable="false" viewBox="0 0 24 24">
                        ...
                        <li class="tab-item">
                            <span class="icon"><svg focusable="false" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path fill="#5f6368"
    ...
    <script src="{{ asset('js/filterAnimals.js') }}" defer></script>
</body>
